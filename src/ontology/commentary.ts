...
export interface CommentaryContext {
    ...
    doctrinalError: string;
    anutikaLogic: string;
    pedagogicalAnalogy?: string;
    detailedSyllogismBreakdown?: string;
}

/**
 * Mapping based on Kathāvatthu Aṭṭhakathā (The Commentary) 
 * and Kathāvatthu Anuṭīkā (The Subcommentary - Focused on Formal Logic and Vāda).
 */
export const AtthakathaOntology: Record<string, CommentaryContext> = {
    'puggala': {
...
/**
 * Função utilitária para buscar a explicação canônica de por que uma heresia foi refutada,
 * baseando-se estritamente no Aṭṭhakathā e na Anuṭīkā.
 */
export function getCommentaryExplanation(subject: string, defeatType: Niggahatthana): string {
